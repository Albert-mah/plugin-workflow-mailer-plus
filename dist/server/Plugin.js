...
var import_MailerPlusInstruction = __toESM(require("./MailerPlusInstruction"));
class Plugin_default extends import_server.Plugin {
  async load() {
    const workflowPlugin = this.app.pm.get(import_plugin_workflow.default);
    workflowPlugin.registerInstruction("mailer-plus", import_MailerPlusInstruction.default);
  }
}
